(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.db, 200, 180, 6, 0.7);
        collectable.create(type.steve, 300, 160, 6, 0.8);
        collectable.create(type.max, 420, 420,);
        collectable.create(type.grace, 350, 500);
